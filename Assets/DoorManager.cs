...
public class DoorManager : MonoBehaviour
{
    ...
    private void DoorCheck() {
        if(left_pressed && right_pressed) Central_Door.SetActive(false);
        else if (left_pressed && central_pressed) Left_Door.SetActive(false);
        else if (central2_pressed && right_pressed) Right_Door.SetActive(false);
        else {
            Central_Door.SetActive(true);
